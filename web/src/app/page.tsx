import { User } from 'lucide-react' // logo de user
import Image from 'next/image' // para colocar imagens com next.js

import nlwLogo from '../assets/nlw-spacetime-logo.svg' // importação da imagem
